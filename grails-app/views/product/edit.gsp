...
<html>
    ...
    <body>
        <a href="#edit-product" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to conten$        <div class="nav" role="navigation">
            <ul>
        ...
        <div id="edit-product" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.product}" method="PUT">
                ...
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'default.button.update.label', default: 'Update$                </fieldset>
            </g:form>
        </div>
    </body>
</html>
